...
class WorkoutDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Initial position of the black card
    final double cardTopPosition = MediaQuery.of(context).size.height * 0.45;

    // The point where the 'Add' button should float
    ...
    final repsOrDuration = isWeightTraining ? 10 : 60;
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          // 1. Bottom Section: Info Card (full description)
          Positioned.fill(
            top: cardTopPosition,
            child: Container(
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        IconButton(
                          ...
                          onPressed: () {
                            // TODO: Implement other menu if needed
                          },
                        ),
                      ],
                    ),
            ...
            child: Center(
              child: ElevatedButton.icon(
                onPressed: () {
                  ...
                  // Optional: Return to the list page after adding
